...
import 'mocha';
import { None, Some, OptionType } from '../src/option/option';
import { map } from '../src/option/operator/map';
import { bind } from '../src/option/operator/bind';
import { defaultValue } from '../src/option/operator/defaultValue';
import { defaultWith } from '../src/option/operator/defaultWith';
import { filter } from '../src/option/operator/filter';
import { count } from '../src/option/operator/count';
import { flatten } from '../src/option/operator/flatten';
